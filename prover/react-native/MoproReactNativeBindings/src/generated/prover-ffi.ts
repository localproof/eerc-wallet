...
interface NativeModuleInterface {
  ...
  ubrn_uniffi_prover_fn_func_generate_circom_proof(
    zkeyPath: Uint8Array,
    circuitInputs: Uint8Array,
    proofLib: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus
  ): Uint8Array;
  ubrn_uniffi_prover_fn_func_generate_gnark_proof(
    r1csPath: Uint8Array,
    pkPath: Uint8Array,
    witnessJson: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus
  ): Uint8Array;
  ubrn_uniffi_prover_fn_func_generate_halo2_proof(
    srsPath: Uint8Array,
    pkPath: Uint8Array,
    circuitInputs: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus
  ): Uint8Array;
  ubrn_uniffi_prover_fn_func_generate_noir_proof(
  ...
  ubrn_uniffi_prover_fn_func_get_noir_verification_key(
    circuitPath: Uint8Array,
    srsPath: Uint8Array,
    onChain: number,
    lowMemoryMode: number,
  ...
  ubrn_uniffi_prover_fn_func_mopro_hello_world(
    uniffi_out_err: UniffiRustCallStatus
  ): Uint8Array;
  ubrn_uniffi_prover_fn_func_verify_circom_proof(
    zkeyPath: Uint8Array,
    proofResult: Uint8Array,
    proofLib: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus
  ): number;
  ubrn_uniffi_prover_fn_func_verify_gnark_proof(
    r1csPath: Uint8Array,
    vkPath: Uint8Array,
    proofResult: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus
  ): number;
  ubrn_uniffi_prover_fn_func_verify_halo2_proof(
    srsPath: Uint8Array,
    vkPath: Uint8Array,
    proof: Uint8Array,
  ...
  ubrn_uniffi_prover_fn_func_verify_noir_proof(
    circuitPath: Uint8Array,
    proof: Uint8Array,
    onChain: number,
    vk: Uint8Array,
...
// Casting globalThis to any allows us to look for `NativeProver`
// if it was added via JSI.
//
// We use a getter here rather than simply `globalThis.NativeProver` so that
// if/when the startup sequence isn't just so, an empty value isn't inadvertantly cached.
const getter: () => NativeModuleInterface = () =>
  (globalThis as any).NativeProver;
