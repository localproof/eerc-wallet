...
export function generateCircomProof(
  ...
  return FfiConverterTypeCircomProofResult.lift(
    uniffiCaller.rustCallWithError(
      ...
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_prover_fn_func_generate_circom_proof(
...
export function generateGnarkProof(
  ...
  return FfiConverterTypeGnarkProofResult.lift(
    uniffiCaller.rustCallWithError(
      ...
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_prover_fn_func_generate_gnark_proof(
...
export function generateHalo2Proof(
  ...
  return FfiConverterTypeHalo2ProofResult.lift(
    uniffiCaller.rustCallWithError(
      ...
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_prover_fn_func_generate_halo2_proof(
...
export function generateNoirProof(
  ...
  return FfiConverterArrayBuffer.lift(
    uniffiCaller.rustCallWithError(
      ...
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_prover_fn_func_generate_noir_proof(
...
export function getNoirVerificationKey(
  ...
  return FfiConverterArrayBuffer.lift(
    uniffiCaller.rustCallWithError(
      ...
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_prover_fn_func_get_noir_verification_key(
          FfiConverterString.lower(circuitPath),
          FfiConverterOptionalString.lower(srsPath),
          FfiConverterBool.lower(onChain),
          FfiConverterBool.lower(lowMemoryMode),
...
export function moproHelloWorld(): string {
  return FfiConverterString.lift(
    uniffiCaller.rustCall(
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_prover_fn_func_mopro_hello_world(
          callStatus
        );
      },
      /*liftString:*/ FfiConverterString.lift
...
export function verifyCircomProof(
  ...
  return FfiConverterBool.lift(
    uniffiCaller.rustCallWithError(
      ...
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_prover_fn_func_verify_circom_proof(
          FfiConverterString.lower(zkeyPath),
...
export function verifyGnarkProof(
  ...
  return FfiConverterBool.lift(
    uniffiCaller.rustCallWithError(
      ...
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_prover_fn_func_verify_gnark_proof(
          FfiConverterString.lower(r1csPath),
...
export function verifyHalo2Proof(
  ...
  return FfiConverterBool.lift(
    uniffiCaller.rustCallWithError(
      ...
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_prover_fn_func_verify_halo2_proof(
          FfiConverterString.lower(srsPath),
          FfiConverterString.lower(vkPath),
...
export function verifyNoirProof(
  ...
  return FfiConverterBool.lift(
    uniffiCaller.rustCallWithError(
      ...
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_prover_fn_func_verify_noir_proof(
          FfiConverterString.lower(circuitPath),
          FfiConverterArrayBuffer.lower(proof),
          FfiConverterBool.lower(onChain),
          FfiConverterArrayBuffer.lower(vk),
...
function uniffiEnsureInitialized() {
  ...
  const scaffoldingContractVersion =
    nativeModule().ubrn_ffi_prover_uniffi_contract_version();
  ...
  if (
    nativeModule().ubrn_uniffi_prover_checksum_func_generate_circom_proof() !==
    36448
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_prover_checksum_func_generate_circom_proof'
    );
  }
  if (
    nativeModule().ubrn_uniffi_prover_checksum_func_generate_gnark_proof() !==
    27169
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_prover_checksum_func_generate_gnark_proof'
    );
  }
  if (
    nativeModule().ubrn_uniffi_prover_checksum_func_generate_halo2_proof() !==
    64165
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_prover_checksum_func_generate_halo2_proof'
    );
  }
  if (
    nativeModule().ubrn_uniffi_prover_checksum_func_generate_noir_proof() !==
    3922
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_prover_checksum_func_generate_noir_proof'
    );
  }
  if (
    nativeModule().ubrn_uniffi_prover_checksum_func_get_noir_verification_key() !==
    5092
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_prover_checksum_func_get_noir_verification_key'
    );
  }
  if (
    nativeModule().ubrn_uniffi_prover_checksum_func_mopro_hello_world() !==
    16029
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_prover_checksum_func_mopro_hello_world'
    );
  }
  if (
    nativeModule().ubrn_uniffi_prover_checksum_func_verify_circom_proof() !==
    2610
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_prover_checksum_func_verify_circom_proof'
    );
  }
  if (
    nativeModule().ubrn_uniffi_prover_checksum_func_verify_gnark_proof() !==
    27530
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_prover_checksum_func_verify_gnark_proof'
    );
  }
  if (
    nativeModule().ubrn_uniffi_prover_checksum_func_verify_halo2_proof() !==
    52925
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_prover_checksum_func_verify_halo2_proof'
    );
  }
  if (
    nativeModule().ubrn_uniffi_prover_checksum_func_verify_noir_proof() !==
    28733
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_prover_checksum_func_verify_noir_proof'
    );
  }
}
