...
import nativeModule from "./prover-ffi.js";
...
export function generateCircomProof(zkeyPath, circuitInputs, proofLib) /*throws*/{
  return FfiConverterTypeCircomProofResult.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_prover_fn_func_generate_circom_proof(FfiConverterString.lower(zkeyPath), FfiConverterString.lower(circuitInputs), FfiConverterTypeProofLib.lower(proofLib), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function generateGnarkProof(r1csPath, pkPath, witnessJson) /*throws*/{
  return FfiConverterTypeGnarkProofResult.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_prover_fn_func_generate_gnark_proof(FfiConverterString.lower(r1csPath), FfiConverterString.lower(pkPath), FfiConverterString.lower(witnessJson), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function generateHalo2Proof(srsPath, pkPath, circuitInputs) /*throws*/{
  return FfiConverterTypeHalo2ProofResult.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_prover_fn_func_generate_halo2_proof(FfiConverterString.lower(srsPath), FfiConverterString.lower(pkPath), FfiConverterMapStringArrayString.lower(circuitInputs), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function generateNoirProof(circuitPath, srsPath, inputs, onChain, vk, lowMemoryMode) /*throws*/{
  return FfiConverterArrayBuffer.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_prover_fn_func_generate_noir_proof(FfiConverterString.lower(circuitPath), FfiConverterOptionalString.lower(srsPath), FfiConverterArrayString.lower(inputs), FfiConverterBool.lower(onChain), FfiConverterArrayBuffer.lower(vk), FfiConverterBool.lower(lowMemoryMode), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function getNoirVerificationKey(circuitPath, srsPath, onChain, lowMemoryMode) /*throws*/{
  return FfiConverterArrayBuffer.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_prover_fn_func_get_noir_verification_key(FfiConverterString.lower(circuitPath), FfiConverterOptionalString.lower(srsPath), FfiConverterBool.lower(onChain), FfiConverterBool.lower(lowMemoryMode), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
/**
...
export function moproHelloWorld() {
  return FfiConverterString.lift(uniffiCaller.rustCall(/*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_prover_fn_func_mopro_hello_world(callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function verifyCircomProof(zkeyPath, proofResult, proofLib) /*throws*/{
  return FfiConverterBool.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_prover_fn_func_verify_circom_proof(FfiConverterString.lower(zkeyPath), FfiConverterTypeCircomProofResult.lower(proofResult), FfiConverterTypeProofLib.lower(proofLib), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function verifyGnarkProof(r1csPath, vkPath, proofResult) /*throws*/{
  return FfiConverterBool.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_prover_fn_func_verify_gnark_proof(FfiConverterString.lower(r1csPath), FfiConverterString.lower(vkPath), FfiConverterTypeGnarkProofResult.lower(proofResult), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function verifyHalo2Proof(srsPath, vkPath, proof, publicInput) /*throws*/{
  return FfiConverterBool.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_prover_fn_func_verify_halo2_proof(FfiConverterString.lower(srsPath), FfiConverterString.lower(vkPath), FfiConverterArrayBuffer.lower(proof), FfiConverterArrayBuffer.lower(publicInput), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
export function verifyNoirProof(circuitPath, proof, onChain, vk, lowMemoryMode) /*throws*/{
  return FfiConverterBool.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeMoproError.lift.bind(FfiConverterTypeMoproError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_prover_fn_func_verify_noir_proof(FfiConverterString.lower(circuitPath), FfiConverterArrayBuffer.lower(proof), FfiConverterBool.lower(onChain), FfiConverterArrayBuffer.lower(vk), FfiConverterBool.lower(lowMemoryMode), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
/**
...
const FfiConverterTypeGnarkProofResult = (() => {
  class FFIConverter extends AbstractFfiConverterByteArray {
    ...
    allocationSize(value) {
      return FfiConverterString.allocationSize(value.proof) + FfiConverterString.allocationSize(value.publicInputs);
    }
  }
  return new FFIConverter();
})();
...
export let MoproError_Tags = /*#__PURE__*/function (MoproError_Tags) {
  ...
  MoproError_Tags["GnarkError"] = "GnarkError";
...
export const MoproError = (() => {
  ...
  class GnarkError_ extends UniffiError {
    /**
     * @private
     * This field is private and should not be used, use `tag` instead.
     */
...
function uniffiEnsureInitialized() {
  ...
  const scaffoldingContractVersion = nativeModule().ubrn_ffi_prover_uniffi_contract_version();
  if (bindingsContractVersion !== scaffoldingContractVersion) {
    throw new UniffiInternalError.ContractVersionMismatch(scaffoldingContractVersion, bindingsContractVersion);
  }
  if (nativeModule().ubrn_uniffi_prover_checksum_func_generate_circom_proof() !== 36448) {
    throw new UniffiInternalError.ApiChecksumMismatch('uniffi_prover_checksum_func_generate_circom_proof');
  }
  if (nativeModule().ubrn_uniffi_prover_checksum_func_generate_gnark_proof() !== 27169) {
    throw new UniffiInternalError.ApiChecksumMismatch('uniffi_prover_checksum_func_generate_gnark_proof');
  }
  if (nativeModule().ubrn_uniffi_prover_checksum_func_generate_halo2_proof() !== 64165) {
    throw new UniffiInternalError.ApiChecksumMismatch('uniffi_prover_checksum_func_generate_halo2_proof');
  }
  if (nativeModule().ubrn_uniffi_prover_checksum_func_generate_noir_proof() !== 3922) {
    throw new UniffiInternalError.ApiChecksumMismatch('uniffi_prover_checksum_func_generate_noir_proof');
  }
  if (nativeModule().ubrn_uniffi_prover_checksum_func_get_noir_verification_key() !== 5092) {
    throw new UniffiInternalError.ApiChecksumMismatch('uniffi_prover_checksum_func_get_noir_verification_key');
  }
  if (nativeModule().ubrn_uniffi_prover_checksum_func_mopro_hello_world() !== 16029) {
    throw new UniffiInternalError.ApiChecksumMismatch('uniffi_prover_checksum_func_mopro_hello_world');
  }
  if (nativeModule().ubrn_uniffi_prover_checksum_func_verify_circom_proof() !== 2610) {
    throw new UniffiInternalError.ApiChecksumMismatch('uniffi_prover_checksum_func_verify_circom_proof');
  }
  if (nativeModule().ubrn_uniffi_prover_checksum_func_verify_gnark_proof() !== 27530) {
    throw new UniffiInternalError.ApiChecksumMismatch('uniffi_prover_checksum_func_verify_gnark_proof');
  }
  if (nativeModule().ubrn_uniffi_prover_checksum_func_verify_halo2_proof() !== 52925) {
    throw new UniffiInternalError.ApiChecksumMismatch('uniffi_prover_checksum_func_verify_halo2_proof');
  }
  if (nativeModule().ubrn_uniffi_prover_checksum_func_verify_noir_proof() !== 28733) {
    throw new UniffiInternalError.ApiChecksumMismatch('uniffi_prover_checksum_func_verify_noir_proof');
  }
}
